...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 04 sep. 2020 à 11:01
...
CREATE TABLE `login` (
  ...
  `leLastName` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `login` (`id`, `InputEmail`, `InputPassword`, `FirstName`, `leLastName`) VALUES
(1, 'louzi.amine.pro@gmail.com', 'ensaj', 'amine', 'louzi'),
(2, 'ensaj@gmail.com', 'ensaj', 'ensa', 'eljadida');
