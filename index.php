...
//echo "WELCOME : " . $_SESSION["InputEmail"] .$_SESSION["InputPassword"] . ".<br>";
//echo "<p class='text-white '>" . $_SESSION["InputEmail"] ."</p>";
?>
            </li>
          </ul>
     <!-- <a class="btn btn-primary" href="SESSION.php" role="button">déconnecté</a>-!-->
